import type { RoomStatus } from '@cahoots/core';
import { LiveIndicator, PeerCursor, PresenceBar } from '@cahoots/cursors';
import {
  useConnectionStatus,
  useCursors,
  useEvent,
      ...
      <section className="hero-panel">
        <div className="hero-panel__copy">
          <div className="hero-panel__eyebrow">
            ...
            <span>Realtime by Cahoots</span>
          </div>
          <h1>See Cahoots feel alive in under five seconds.</h1>
          <p>
      ...
      <section className="demo-layout">
        <aside className="demo-sidebar">
          ...
          <div className="sidebar-card">
            ...
            <p>
              This room uses Cahoots presence, cursor sync, custom events, and CRDT-backed shared
