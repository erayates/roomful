...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      logo: {
        light: './src/assets/cahoots-mark.svg',
        dark: './src/assets/cahoots-mark.svg',
        replacesTitle: false,
      },
      social: [
        {
          icon: 'github',
          label: 'GitHub',
          href: 'https://github.com/erayates/cahoots',
        },
      ],
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Discussions',
              link: 'https://github.com/erayates/cahoots/discussions',
            },
            {
              label: 'Issues',
              link: 'https://github.com/erayates/cahoots/issues',
            },
          ],
        },
      ],
