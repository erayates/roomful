...
```bash
K6_BIN=/absolute/path/to/k6 pnpm --filter @roomful/relay benchmark:load:steady
```
...
```bash
pnpm --filter @roomful/relay benchmark:load:steady
pnpm --filter @roomful/relay benchmark:load:scale -- --redis-url redis://127.0.0.1:6379/0
pnpm --filter @roomful/relay benchmark:load:soak -- --redis-url redis://127.0.0.1:6379/0
```
...
```bash
pnpm --filter @roomful/relay benchmark:load:scale -- --redis-url redis://127.0.0.1:6379/0 --vus 600
pnpm --filter @roomful/relay benchmark:load:scale -- --redis-url redis://127.0.0.1:6379/0 --vus 700
pnpm --filter @roomful/relay benchmark:load:scale -- --redis-url redis://127.0.0.1:6379/0 --vus 800
```
