...
const narrativeOrder = {
  ...
  'reference/engines-viewport': 6,
  'reference/engines-locks': 7,
  'reference/engines-pointer': 8,
  'reference/engines-comments': 9,
  'reference/engines-history': 10,
  'reference/adapters-react': 11,
  'reference/adapters-vue': 12,
  'reference/adapters-svelte': 13,
  'reference/adapters-solid': 14,
  'reference/adapters-angular': 15,
  'reference/advanced': 16,
  'reference/auth-nextjs': 17,
  'reference/ui-components': 18,
  'reference/devtools-debugging': 19,
  'reference/performance': 20,
  'reference/types': 21,
