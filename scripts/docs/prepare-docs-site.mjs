...
const narrativeOrder = {
  ...
  'reference/adapters-solid': 9,
  'reference/adapters-angular': 10,
  'reference/advanced': 11,
  'reference/auth-nextjs': 12,
  'reference/ui-components': 13,
  'reference/devtools-debugging': 14,
  'reference/performance': 15,
  'reference/types': 16,
