...
A `room` is the primary collaboration scope in Cahoots.
...
| `websocket` | larger rooms or strict network environments | Yes (`@cahoots/relay`)   | Relay-backed room messaging with targeted send + broadcast support                                                                 |
