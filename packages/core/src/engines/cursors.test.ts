...
describe('createCursorEngine', () => {
  ...
  it('renders the default style as an SVG arrow with a colored name label', () => {
    ...
    expect(cursorNode.getAttribute('data-roomful-cursor-style')).toBe('default');
    ...
    expect(marker.getAttribute('data-roomful-cursor-marker-style')).toBe('default');
    expect(marker.getAttribute('data-roomful-cursor-marker-color')).toBe('#111111');
  ...
  it('supports dot and pointer styles, unknown fallback, and repeated render updates', () => {
    ...
    expect(cursorNode.getAttribute('data-roomful-cursor-style')).toBe('dot');
    expect(marker.tagName).toBe('span');
    expect(marker.getAttribute('data-roomful-cursor-marker-style')).toBe('dot');
    expect(marker.getAttribute('data-roomful-cursor-marker-color')).toBe('#111111');
    ...
    expect(board.children).toHaveLength(1);
    expect(cursorNode.getAttribute('data-roomful-cursor-style')).toBe('pointer');
    expect(marker.tagName).toBe('div');
    expect(marker.getAttribute('data-roomful-cursor-marker-style')).toBe('pointer');
  ...
  it('falls back to the default color when a rendered cursor has no color value', () => {
    ...
    let marker = getMarker(cursorNode);
    let label = getLabel(cursorNode);
    expect(marker.getAttribute('data-roomful-cursor-marker-color')).toBe('#111827');
