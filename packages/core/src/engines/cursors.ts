...
const CURSOR_ROOT_ATTRIBUTE = 'data-cahoots-cursor-root';
const CURSOR_NODE_ATTRIBUTE = 'data-cahoots-peer-cursor';
const CURSOR_USER_ATTRIBUTE = 'data-user-id';
const CURSOR_IDLE_ATTRIBUTE = 'data-idle';
const CURSOR_STYLE_ATTRIBUTE = 'data-cahoots-cursor-style';
const CURSOR_MARKER_ATTRIBUTE = 'data-cahoots-cursor-marker';
const CURSOR_MARKER_STYLE_ATTRIBUTE = 'data-cahoots-cursor-marker-style';
const CURSOR_MARKER_COLOR_ATTRIBUTE = 'data-cahoots-cursor-marker-color';
const CURSOR_LABEL_ATTRIBUTE = 'data-cahoots-cursor-label';
