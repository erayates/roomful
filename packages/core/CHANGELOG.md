...
Initial public release of `@flockjs/core`, the framework-agnostic TypeScript core for FlockJS collaboration.
...
- `FlockError` runtime error class and boundary-safe (`unknown`) event payloads.
