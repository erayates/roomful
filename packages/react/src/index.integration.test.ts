...
import type { CursorData, PresenceData } from '@cahoots/core';
...
describe('React adapter integration', () => {
  it('mounts CahootsProvider and connects successfully', async () => {
    ...
    expect(TrackingBroadcastChannel.getChannelCount(`cahoots:${roomId}`)).toBe(1);
