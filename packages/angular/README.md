...
> **Stable — v1.5.** Realtime presence, cursors, and shared state, plus the collaboration primitives (`injectViewport`, `injectLocks`, `injectPointer`, `injectComments`, `injectHistory`). The API is stable and ready for production.
