...
- ed6e6cb: Add the `injectActivity` function (EP-15): returns a `Signal` of the room activity feed
...
- c4764ed: Add the Angular adapter (`@roomful/angular`), the second v1.1 "Ecosystem" deliverable.
