...
export function SelectionHighlight<TPresence extends PresenceData = PresenceData>(
  ...
  const reactId = useId();
  const highlightName = sanitizeHighlightName(`cahoots-selection-${peer.id}-${reactId}`);
...
function applyCustomHighlight(
  ...
  styleElement.setAttribute('data-cahoots-selection-highlight-style', highlightName);
  styleElement.setAttribute('data-cahoots-selection-highlight-style-peer', peerId);
...
function wrapTextNodeSegment(
  ...
  wrapper.setAttribute('data-cahoots-selection-highlight', 'true');
  wrapper.setAttribute('data-cahoots-selection-highlight-peer', peerId);
